                  ...
                  >
                    ...
                    >
                      <p className="fst-italic">
                        The recipe category of diet type refers to the
                        classification of recipes based on their suitability for
                        specific dietary needs or preferences.
                      </p>
                      <ul>
                        <li>
                          <i className="fa-solid fa-square-check mt-2"></i>At
                          This category of recipes includes recipes that cater
                          to a variety of diets, including vegetarian, vegan,
                          gluten-free, dairy-free, paleo, keto, and many others.{" "}
                        </li>
                        <li>
                          <i className="fa-solid fa-square-check"></i>Recipes in
                          the diet type category are designed to meet the unique
                          nutritional requirements of individuals with specific
                          dietary restrictions or preferences.
                        </li>
                        <li>
                          <i className="fa-solid fa-square-check"></i>Recipes in
                          the diet type category often rely on alternative
                          ingredients and substitutes to achieve the desired
                          flavor and texture.
                        </li>
                      </ul>
                      <p>
                        Overall, the diet type category of recipes is a
                        reflection of the diverse dietary needs and preferences
                        of individuals, and serves as a resource for individuals
                        seeking to maintain a healthy and balanced diet that
                        meets their unique nutritional requirements.
                      </p>
                    </motion.div>
                  </div>
                </div>
