...
/* Declaring the variables. */
   ...
   * @returns An array of values from the selected options.
   */
 ...
 */
  ...
  */
  const instructionchange = (e) => {
    setRecipe({
      ...recipe,
      instruction: e.target.value.replaceAll(".\n", ".").split("."),
    });
  };
  //final page
/**
      ...
      <AnimatedPage>
        {CurrentRecipeItem.recipe &&
          CurrentRecipeItem.recipe.map((element) => {
            return (
              <section
                className="intro py-5 min-vh-100 "
                key={element._id}
                                      ...
                                      <div className="row">
                                        <div className="col">
                                          ...
                                          >
                                            <option
                                              value="Balanced"
                                              selected={element.dietLabels.includes(
                                                "Balanced"
                                              )}
                                            >
                                              {" "}
                                        ...
                                        <div className="col">
                                          ...
                                          >
                                            <option
                                              ...
                                              selected={element.healthLabels.includes(
                                                "Alcohol-Cocktail"
                                              )}
                                            >
                                              {" "}
                                      ...
                                      <div className="row">
                                        <div className="col">
                                          ...
                                          >
                                            <option
                                              value="american"
                                              selected={element.cuisineType.includes(
                                                "american"
                                              )}
                                            >
                                              {" "}
                                        ...
                                        <div className="col">
                                          ...
                                          >
                                            <option
                                              value="breakfast"
                                              selected={element.mealType.includes(
                                                "breakfast"
                                              )}
                                            >
                                              {" "}
                                        ...
                                        <div className="col">
                                          ...
                                          >
                                            <option
                                              ...
                                              selected={element.dishType.includes(
                                  ...
                                  <div className="card-body  py-5 px-4 p-md-5">
                                    ...
                                    <form action="">
                                      <Textarea
                                        bordered
                                        color="primary"
                                        initialValue={element.instruction
                                          .toString()
                                          .replaceAll(".,", `.\n`)}
                                        name="instruction"
