...
/**
 * It takes a file, sends it to the server, and then updates the user's profile image
 ...
 */
    ...
    try {
      if (filesize == 0) {
        ...
        const response = await fetch(
          `${process.env.REACT_APP_Fetch_Api_Start}/auth/changeuploadimageAdmin`,
          {
            method: "POST",
            mode: "cors",
            headers: {
 ...
 /**
  * If the file size is greater than 100000, show an alert. Otherwise, change the profile image.
  */
  const changefile = () => {
    if (filesize > 100000) {
  ...
  //form submit
/**
 * The function is called submit and it takes an event as an argument. The function prevents the
 ...
 */
  ...
  /**
   * If the submit button is visible, hide it and show the display button. If the submit button is
   * hidden, show it and hide the display button.
   */
  const visibleSubmit = () => {
    if (
 ...
 /**
  * If the imagechangecontrols div is visible, hide it. If it's hidden, show it.
  */
...
/**
 * When the user changes the value of the input field, update the state of the user object with the new
 * value.
 * @param e - the event object
 */
...
/**
 * It takes a data object, makes a fetch request to the server, and then updates the state of the
 * component.
 * @param data - {
 */
...
/**
 * If the user has not changed any of the fields, show an alert. If the phone number is not 10 digits,
 * show an alert. If the first name is less than 3 characters, show an alert. If the email is not in
 * the correct format, show an alert. If the username is less than 8 characters, show an alert.
 * Otherwise, update the account details.
 * 
              ...
              <div className="container py-5">
                <div className="row mt-2">
                      ...
                      <div className="card-body p-0">
                        ...
                        >
                          ...
                          <li className="list-group-item d-flex justify-content-between align-items-center p-3">
                            ...
                            ></i>
                            <p className="mb-0">
                              {userbyid?.user?.twitter
                                ? userbyid?.user?.twitter + ".twitter"
                                : "recipe.twitter"}
                            </p>
                          </li>
                          ...
                          <li className="list-group-item d-flex justify-content-between align-items-center p-3">
                            ...
                            ></i>
                            <p className="mb-0">
                              {userbyid?.user?.facebook
                                ? userbyid?.user?.facebook + ".facebook"
                                : "recipe.facebook"}
                            </p>
                          </li>
                        </ul>
                  ...
                  <div className="col-xl-8 accountdetailcard ">
                    ...
                    <div className="card border-info mb-4 box_decrease_size_animation">
                      <div className="card-header border-info d-flex justify-content-between ">
                        Account Details ( Details are not relevant, Please
                        reload page Once.){" "}
                        <i
                          className="fa-solid fa-pen"
                        ...
                        >
                          <div className="mb-3 col-7">
                            ...
                            <input
                              ...
                              defaultValue={userbyid?.user?.username}
                            />
                            <div
                          ...
                          <div className="row gx-3 mb-3">
                            <div className="col-md-6">
                              ...
                              <input
                                ...
                                onChange={userdetailchange}
                                defaultValue={userbyid?.user?.first_name}
                              />
                            </div>
                            ...
                            <div className="col-md-6">
                              ...
                              <input
                                ...
                                onChange={userdetailchange}
                                defaultValue={userbyid?.user?.last_name}
                              />
                            </div>
                          </div>
                          ...
                          <div className="row gx-3 mb-3">
                            <div className="col-md-6">
                              ...
                              <input
                                ...
                                onChange={userdetailchange}
                                defaultValue={userbyid?.user?.phone_number}
                              />
                            </div>
                          </div>
