                  ...
                  <div className="card-body box_decrease_size_animationforlogin ">
                    <form>
                      <div className="row px-2 mt-3 box_decrease_size_animationemailsignup   mb-1">
                        <Input
                          {...bindings}
                          contentLeft={<i className="fa-solid text-warning fa-envelope"></i>}
                          shadow={false}
                          onClearClick={reset}
                          required
                          color={helper.color}
                      ...
                      <div className="d-flex justify-content-between pt-2 ">
                        <div className="px-3 box_decrease_size_animationforlogin mb-1">
                          <Input
                            ...
                            bordered
                            rounded
                            contentLeft={<i className="fa-solid text-info fa-signature"></i>}
                      ...
                      <div className="d-flex justify-content-between pt-2">
                        <div className="px-3 box_decrease_size_animationforlogin mb-1">
                          <Input
                            className="bg-white"
                            size="md"
                            contentLeft={<i className="fa-solid text-primary fa-user"></i>}
                            bordered
                            rounded
                        ...
                        <div className="box_decrease_size_animationforlogin mb-1">
                          <Input
                            ...
                            bordered
                            rounded
                            contentLeft={<i className="fa-solid text-success fa-phone"></i>}
                      ...
                      <div className="d-flex justify-content-between pt-2">
                        <div className="px-3 box_decrease_size_animationforlogin mb-1">
                          <Input.Password
                            className="bg-white"
                            contentLeft={<i className="fa-solid text-danger fa-key"></i>}
                            bordered
                            rounded
                            onChange={onchange}
                            // color="warning"
