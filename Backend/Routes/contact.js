/* This is importing all the required packages and modules. */
...
router.post("/Message", async (req, res) => {
  try {
    const alreadymessage = await Contact.findOne({
...
/* This is a router to get all the messages. */
...
/* This is a router to delete all the messages. */
